...
"[project]/node_modules/.pnpm/lexical@0.20.0/node_modules/lexical/Lexical.dev.mjs [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const COMPOSITION_SUFFIX = ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : ZERO_WIDTH_SPACE;
const DOUBLE_LINE_BREAK = '\n\n';
// For FF, we need to use a non-breaking space, or it gets composition
// in a stuck state.
const COMPOSITION_START_CHAR = ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : COMPOSITION_SUFFIX;
const RTL = '\u0591-\u07FF\uFB1D-\uFDFD\uFE70-\uFEFC';
...
function isDeleteWordBackward(key, altKey, ctrlKey) {
    return isBackspace(key) && (("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : ctrlKey);
}
function isDeleteWordForward(key, altKey, ctrlKey) {
    return isDelete(key) && (("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : ctrlKey);
}
...
function isCopy(key, shiftKey, metaKey, ctrlKey) {
    ...
    if (key.toLowerCase() === 'c') {
        return ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : ctrlKey;
    }
    return false;
}
...
function $shouldPreventDefaultAndInsertText(selection, domTargetRange, text, timeStamp, isBeforeInput) {
    ...
    const editor = getActiveEditor();
    const domSelection = getDOMSelection(editor._window);
    const domAnchorNode = ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : null;
...
function onDocumentSelectionChange(event) {
    ...
    "TURBOPACK unreachable";
    const nextActiveEditor = undefined;
    // When editor receives selection change event, we're checking if
    // it has any sibling editors (within same parent editor) that were active
    // before, and trigger selection change on it to nullify selection.
    const editors = undefined;
    const rootEditor = undefined;
    const rootEditorKey = undefined;
    const activeNestedEditor = undefined;
    const prevActiveEditor = undefined;
}
...
LexicalEditor.version = "0.20.0+dev.esm";
;
}}),

};

//# sourceMappingURL=f9846_lexical_Lexical_dev_mjs_f5a2f2._.js.map